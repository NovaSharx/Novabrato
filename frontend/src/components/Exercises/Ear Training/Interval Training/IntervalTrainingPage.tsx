    ...
    return (
        <Fragment>
            ...
            <h2 className='page-title' style={{ borderBottom: `2px solid ${theme.palette.divider.tertiary}` }}>
                <a href="/exercises">EXERCISES</a><a href="/exercises/ear-training" style={{ fontSize: '0.8em' }}>Ear Training</a><a href="interval-training" style={{ fontSize: '0.6em' }}>Interval Training</a>
            </h2>
